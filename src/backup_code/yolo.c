...
char *voc_names[] = {"stopsign"};
image voc_labels[CLASSNUM];

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "BBox-Label-Tool-master/stop_sign_list.txt";
...
void demo_yolo(char *cfgfile, char *weightfile, float thresh, char* filename);
#ifndef GPU
void demo_yolo(char *cfgfile, char *weightfile, float thresh, char* filename)
{
...
void run_yolo(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo")) demo_yolo(cfg, weights, thresh, filename);
}
