...
//printf("In fill truth region, count= %d\n", count);

    randomize_boxes(boxes, count);
    correct_boxes(boxes, count, dx, dy, sx, sy, flip);

//printf("After correction, count= %d\n", count);
    ...
    for (i = 0; i < count; ++i) {
        ...
        //printf("writing to truth!\n");
        truth[index++] = x;
        truth[index++] = y;
        truth[index++] = w;
        truth[index++] = h;
        //printf("(truth[0], truth[1], truth[2], truth[3])= (%d, %d, %d, %d) \n", truth[0], truth[1], truth[2], truth[3]);
    }
    free(boxes);
}
...
//printf("in get_random_batch() from data.c:\n  y[0]= %f, y[1]=%f ,y[2]= %f, y[3]= %f", y[0], y[1], y[2], y[3]);
}
...
//printf("in get_next_batch() from data.c:\n  y[0]= %f, y[1]=%f ,y[2]= %f\n, d.y.cols*sizeof(float)= %f\n", y[0], y[1], y[2], d.y.cols*sizeof(float));
}
